...
export default function Product({ productData }: Props) {
  ...
  return (
    <div className="w-screen min-h-screen h-auto flex items-center justify-center flex-col dark:bg-[rgba(55,55,55,1)]">
      <div className="lg:grid lg:grid-cols-2 lg:gap-10 h-full w-full p-16 xs:p-20 lg:mx-10 mt-10 animate-appearing">
        ...
        <div className="flex items-start justify-start flex-col w-full h-full pt-10 xs:p-10">
          ...
          <form className="flex flex-col justify-between w-full lg:w-1/2" onSubmit={handleAddToCart}>
            <div className="flex flex-row justify-between xs:justify-around lg:justify-between xs:gap-16 my-10 xs:mt-16 xs:mb-0 lg:my-10 text-white">
              <div>
